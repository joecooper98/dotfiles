...
export SHARC=~/Programs/sharc/sharc/bin

TIMEFMT=$'%J\nElapsed      %uE\nUser         %uU\nSystem       %uS\nCPU          %P\nMax Mem (KB) %M'  

# Alias definition
alias sshsrv='kitty +kitten ssh -XY joe@ak-srv1.chem.ed.ac.uk'
alias sftpsrv='sftp joe@ak-srv1.chem.ed.ac.uk'
alias ssheddie='kitty +kitten ssh -XY s2129248@eddie.ecdf.ed.ac.uk'
alias sftpeddie='sftp s2129248@eddie.ecdf.ed.ac.uk'
alias vi='vim'
alias v='vim'
alias cdsftp='cd ~/Documents/SFTPDUMP'
